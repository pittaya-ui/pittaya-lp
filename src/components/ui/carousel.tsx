    ...
    <div className={cn("group relative w-full", className)}>
        ...
        <>
          <Button
            ...
            className={cn(
              ...
              "h-12 w-12 rounded-full backdrop-blur-sm",
      ...
      {(showDots || showCounter) && (
        <div className="absolute bottom-6 left-1/2 z-10 flex -translate-x-1/2 items-center gap-2">
          {showDots && (
            <div className="bg-background/80 border-border/50 flex items-center gap-2 rounded-full border px-4 py-2 shadow-lg backdrop-blur-sm">
              {items.map((_, index) => (
                <button
                  key={index}
          ...
          {showCounter && (
            <div className="bg-background/80 border-border/50 rounded-full border px-3 py-2 shadow-lg backdrop-blur-sm">
