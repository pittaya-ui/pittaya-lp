                ...
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-transparent dark:bg-black">
                  {images.map((imageSrc, index) => {
                    ...
                    return (
                      <div
                        key={`${imageSrc}-${index}`}
                        className="absolute z-0 h-16 w-16 overflow-hidden rounded-lg border border-white shadow-sm sm:rounded-xl sm:border-2 md:h-26 md:w-26 lg:h-24 lg:w-24 dark:border-gray-800"
                        style={{
